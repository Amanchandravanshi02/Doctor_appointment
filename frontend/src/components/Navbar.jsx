...
const Navbar = () => {
  ...
  return (
    <div className='flex item-center justify-between text-sm py-4 mb-5 border-b border-b-gray-500'>
        ...
        <div className='flex items-center gap-4'>
            {
                ...
                :<button onClick={()=>navigate('/login')} className='bg-primary text-white px-8 py-2 rounded-full font-light md:block'>Create account</button>
